...
namespace All_in_One.Logik_Side.Data
{
    ...
    public static class Config
    {
        public static Dictionary<Spell_Category.Spell_CategoryType, BestCategorieBaseClass> DKPRequirement = new()
        {
            ...
            {Spell_Category.Spell_CategoryType.Rapidfire, new BestCategorieBaseClass(0,25,Effect_Category.Effect_CategoryType.Cast)},
            {Spell_Category.Spell_CategoryType.SliceDice, new BestCategorieBaseClass(50,25,Effect_Category.Effect_CategoryType.Cast)}
        };
    }
}
